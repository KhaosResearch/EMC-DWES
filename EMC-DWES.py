...
df = pd.read_excel ('D:\docs-irland-DataS-Navid-Coverletter-Customer\DataS\dataset2\colon.xlsx', header=None)
df.iloc[:,df.shape[1]-1].replace({'Normal':1, 'Tumor':2},inplace=True)

# CNS; labels are 1 or 2
# df = pd.read_excel ('D:\docs-irland-DataS-Navid-Coverletter-Customer\DataS\dataset2\CNS.xlsx', header=None)
# df.iloc[:,df.shape[1]-1].replace({0:2},inplace=True)

# Leukemia-2c; labels are 1 or 2
# df = pd.read_excel ('D:\docs-irland-DataS-Navid-Coverletter-Customer\DataS\dataset2\Leukemia.xlsx', header=None)
#
#SMK
# df = pd.read_csv ('D:\docs-irland-DataS-Navid-Coverletter-Customer\DataS\dataset2\SMK.csv', header=None)
# df.iloc[:,df.shape[1]-1].replace({0:2},inplace=True)

# GLI
# df = pd.read_csv ('D:\docs-irland-DataS-Navid-Coverletter-Customer\DataS\dataset2\GLI.csv', header=None)
# df.iloc[:,df.shape[1]-1].replace({0:2},inplace=True)

# covid-2c
# df = pd.read_csv ('D:\docs-irland-DataS-Navid-Coverletter-Customer\DataS\dataset2\Covid.csv', header=None)
...
#Leukemia-3c
# df = pd.read_excel ('D:\docs-irland-DataS-Navid-Coverletter-Customer\DataS\dataset2\Leukemia_3c.xlsx', header=None)

#MLL-3c
# df = pd.read_excel ('D:\docs-irland-DataS-Navid-Coverletter-Customer\DataS\dataset2\MLL.xlsx', header=None)

#SRBCT-4c
# df = pd.read_excel ('D:\docs-irland-DataS-Navid-Coverletter-Customer\DataS\dataset2\SRBCT.xlsx', header=None)
